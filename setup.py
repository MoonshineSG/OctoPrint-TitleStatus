...
plugin_identifier = "title_status"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_title_status"
...
# module
plugin_description = """Show printers status in window title"""
...
plugin_url = "https://github.com/MoonshineSG/OctoPrint-TitleStatus"
